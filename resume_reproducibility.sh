...
set -uo pipefail
# RESUME wrapper -- generated 2026-08-24. Same command line plus -resume.
...
LOG="$WS/REPRO_${TAG}_resumed.log"
WDOG="$WS/REPRO_${TAG}_resumed.watchdog.log"
...
[ -d "$WORK" ] || { echo "FATAL: work dir $WORK missing — cannot resume"; exit 1; }
[ -d "/home/phemarajata/wf-assembly-snps-mod-79ab645/.nextflow/cache" ] || { echo "FATAL: resume cache gone from the launch dir"; exit 1; }
