...
| ⚠ **Liang S, Mei S, Ji J, … Zhang H. DeepSANet: hierarchical geographical source attribution of *Salmonella*. *Food Res Int* 2025;221(Pt 4):117554.** PMID **41185308** ✅ | **80.83% COUNTRY-level, 87.05% subregion, 91.88% region**, from only **3,002 cgMLST loci**; >90% at all levels on EnteroBase | **The most dangerous paper for this manuscript — address it, do not omit it.** Same feature type, comparable locus count, success at the scale we report as unreachable. Three distinctions, strongest first: (1) **holdout design** — the abstract states none, and our own country result reaches 29–37% under leave-*one*-out before collapsing under leave-*group*-out; Yu 2025 argues exactly this confound. **Read their methods before writing the rebuttal.** (2) organism — *B. pseudomallei* is environmental, r/m 7.70, with lineages spanning continents (ST92; Viet Nam/Georgia at one locus). (3) reference density — EnteroBase vs 9,040 BioSamples with **7 of our 16 source countries at zero**. **Framed correctly, DeepSANet is consistent with our thesis** (attribution reaches as far as the panel) rather than a refutation |
